	...
	<div class="setbody">
		<div class="box">
			...
			<div class="bitem">
				...
				<div class="bbt">
					<h3 style="font-weight:bold;">用戶資料表如下</h3>
					<div class="tb">
					<%
						try {
							...
							String sql = "select id, account, name, tel, email from members";
							ResultSet rs = stmt.executeQuery(sql);

							out.print("<table style='width:650px;'>");
							out.print("<th>用戶編號</th>");
							out.print("<th>帳號</th>");
							out.print("<th>姓名</th>");
							out.print("<th>電話</th>");
					...
					<fieldset style="margin-left: 80px;text-align: left;">
		                <h3 style="color: red; margin-bottom: 30px;font-weight:bold;font-weight:bold;">刪除資料</h3>
		                <form action="/Libary/Adel" id="myform" method="POST">
						<label style="font-size:18px;">用戶編號 :</label><input type="text" name="id" id="id" size="15" required pattern="[1-9]{1,}" title="請輸入數字編號"><br><br>
