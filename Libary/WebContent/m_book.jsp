				...
				<div class="bbt">
					...
					<%
						try {
							...
							String sql = "select bid, account,bnum,bname,quantity,date from booking";
                	...
                	<fieldset style="margin-left: 80px;text-align: left;">
		                <h3 style="color: red; margin-bottom: 30px;font-weight:bold;">刪除資料</h3>
		                <form action="/Libary/Bdel" id="myform" method="POST">
		                <label style="font-size:18px;">訂單編號 :</label><input type="text" name="id" id="id" size="15" required pattern="[0-9]{1,}" title="請輸入訂單編號"><br><br>
						<label style="font-size:18px;">用戶帳號 :</label><input type="text" name="account" id="account" size="15" required pattern="[^/\\\.\?\*\$\+,;\^!@#%~`=]*" title="請輸入用戶帳號"><br><br>
						<label style="font-size:18px;">書籍編號 :</label><input type="text" name="bnum" id="bnum" size="15" required pattern="00[1-9]{1}" title="請輸入書籍編號"><br><br>
